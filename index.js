/* 
This code has been copied and slightly modified from vitejs/create-app
so full credits go to Evan You and the @vitejs team.
...
const TEMPLATES = [
  yellow('polka-apollo-typescript'),
]
